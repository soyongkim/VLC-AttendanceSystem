...
import com.example.soyongkim.vlc_receiver.controller.receiver.TimerNotificationActionReceiver
...
class NotificationUtil {
    companion object {
        ...
        fun showTimerExpired(context: Context){
            ...
            nBuilder.setContentTitle("Finished Checking!")
                    .setContentText("Start again?")
                    .setContentIntent(getPendingIntentWithStack(context, AttendanceAdminActivity::class.java))
        ...
        fun showTimerRunning(context: Context, wakeUpTime: Long){
            ...
            val nBuilder = getBasicNotificationBuilder(context, CHANNEL_ID_TIMER, true)
            nBuilder.setContentTitle("Checking...")
